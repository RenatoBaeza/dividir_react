        ...
        <div className="prose prose-neutral dark:prose-invert">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>Información de tu cuenta de Google (email, nombre y foto de perfil)</li>
          ...
          <section className="mb-8">
            ...
            <p>
              Nos comprometemos a proteger tus datos personales y tomamos medidas de seguridad 
              para prevenir el acceso no autorizado o la divulgación de tu información.
            </p>
          </section>
